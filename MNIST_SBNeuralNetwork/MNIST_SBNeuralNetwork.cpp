...
int main()
{
	...
	// Model definitions
	std::vector<size_t> dims = { 784, 128, 128, 10 };
	...
	model.compile(NeuralNetwork::loss_metric::one_hot, NeuralNetwork::loss_metric::accuracy, NeuralNetwork::weight_init::normalize);
